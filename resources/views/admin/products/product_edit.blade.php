                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-primary btn-round ms-auto" href="{{ route('products.index') }}">
                                        ...
                                        @foreach ($product->images as $image)
                                            <div class="col-md-2" id="image-container-{{ $image->id }}">
                                                <div class="form-group mb-3" style="position: relative;">
                                                    ...
                                                    href="{{ route('admin.product-image-delete', $image->id) }}" 
                                                ...
                                                <a class="btn btn-danger btn-sm" 
                                                    ...
                                                    @else
                                                        ...
                                                        <a class="btn btn-danger btn-sm" style="position: absolute; right:0; top:0"
                                                           href="{{ route('admin.product-image-delete', $image->id) }}" id="delete"
                                ...
                                <div class="variant-sizes">
                                    <div class="row size-row">
                                        ...
                                        <div class="col-2 mt-2">
                                            <a href="{{ route('admin.product-stock-delete', $info->id) }}" type="button" 
